...
function computeResults(e) {
  ...
  const total = (har*220 + dj*220 + mar*280 + kmar*500 + jee*220 + mus*80 + meth*90 + ajm*250 +suth*600 + gm*0.85 + sm*0.65 + pbm*0.7 +  Math.round(cm*.333333) + Math.round(ppm*0.333333) + dm*110 + dc*65 + dtd*120 + baj*40 + ric*33 + kric*120 + jag*60 + go*2430).toFixed(0);
...
if(cm != "")
{
  msg = msg + "Chat M.                           "+ cm+  "g    " +  Math.round(cm*.333333) + " %0a ";    
